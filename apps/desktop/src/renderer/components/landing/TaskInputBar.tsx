...
export default function TaskInputBar({
  ...
  // Safe accomplish access — may not be available in browser mode
  let accomplish: ReturnType<typeof getAccomplish> | null = null;
  try {
    accomplish = getAccomplish();
  } catch {
    // Running in browser mode without Electron
  }
